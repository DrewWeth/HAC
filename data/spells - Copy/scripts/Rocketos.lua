...
local dfcombat0_Brush = {CONST_ANI_POISON,0,1,-1,2,0,2,1,2,0,3}

-- Areas/Combat for 100ms
local combat1_Brush = createCombatObject()
setCombatParam(combat1_Brush, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatArea(combat1_Brush,createCombatArea({{0, 0, 1, 0},
{2, 1, 1, 1},
{0, 0, 1, 0}}))
function getDmg_Brush(cid, level, maglevel)
	return (1000000)*-1,(1000000)*-1 
...
local dfcombat1_Brush = {CONST_ANI_POISON,1,0,2,1,3,0,2,0,2,-1}
...
local dfcombat2_Brush = {CONST_ANI_POISON,0,-1,0,-2,1,-2,0,-3,-1,-2}local combat2_Brush_2 = createCombatObject()
setCombatParam(combat2_Brush_2, COMBAT_PARAM_EFFECT, CONST_ME_HITAREA)
...
setCombatArea(combat3_Brush,createCombatArea({{0, 1, 0, 0},
{1, 1, 1, 2},
{0, 1, 0, 0}}))
function getDmg_Brush(cid, level, maglevel)
	return (1000000)*-1,(1000000)*-1 
...
local dfcombat3_Brush = {CONST_ANI_POISON,-1,0,-2,0,-2,1,-2,-1,-3,0}local combat3_Brush_2 = createCombatObject()
setCombatParam(combat3_Brush_2, COMBAT_PARAM_EFFECT, CONST_ME_HITAREA)
setCombatParam(combat3_Brush_2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatArea(combat3_Brush_2,createCombatArea({{0, 0, 1, 0},
{2, 1, 1, 1},
{0, 0, 1, 0}}))
function getDmg_Brush_2(cid, level, maglevel)
	return (1000000)*-1,(1000000)*-1 
...
local dfcombat4_Brush = {CONST_ANI_POISON,0,1,0,2,-1,2,0,3,1,2}local combat4_Brush_2 = createCombatObject()
setCombatParam(combat4_Brush_2, COMBAT_PARAM_EFFECT, CONST_ME_HITAREA)
...
setCombatArea(combat5_Brush,createCombatArea({{0, 0, 1, 0},
{2, 1, 1, 1},
{0, 0, 1, 0}}))
function getDmg_Brush(cid, level, maglevel)
	return (1000000)*-1,(1000000)*-1 
...
local dfcombat5_Brush = {CONST_ANI_POISON,1,0,2,0,2,1,3,0,2,-1}local combat5_Brush_2 = createCombatObject()
setCombatParam(combat5_Brush_2, COMBAT_PARAM_EFFECT, CONST_ME_HITAREA)
setCombatParam(combat5_Brush_2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatArea(combat5_Brush_2,createCombatArea({{0, 1, 0, 0},
{1, 1, 1, 2},
{0, 1, 0, 0}}))
function getDmg_Brush_2(cid, level, maglevel)
	return (1000000)*-1,(1000000)*-1 
...
setCombatArea(combat6_Brush,createCombatArea({{0, 1, 0},
{1, 1, 1},
{0, 1, 0},
{0, 2, 0}}))
function getDmg_Brush(cid, level, maglevel)
...
local dfcombat6_Brush = {CONST_ANI_POISON,0,-1,0,-2,-1,-2,0,-3,1,-2}local combat6_Brush_2 = createCombatObject()
setCombatParam(combat6_Brush_2, COMBAT_PARAM_EFFECT, CONST_ME_HITAREA)
...
setCombatArea(combat7_Brush,createCombatArea({{0, 1, 0, 0},
{1, 1, 1, 2},
{0, 1, 0, 0}}))
function getDmg_Brush(cid, level, maglevel)
	return (1000000)*-1,(1000000)*-1 
...
local dfcombat7_Brush = {CONST_ANI_POISON,-1,0,-2,0,-3,0,-2,1,-2,-1}local combat7_Brush_2 = createCombatObject()
setCombatParam(combat7_Brush_2, COMBAT_PARAM_EFFECT, CONST_ME_HITAREA)
setCombatParam(combat7_Brush_2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatArea(combat7_Brush_2,createCombatArea({{0, 0, 1, 0},
{2, 1, 1, 1},
{0, 0, 1, 0}}))
function getDmg_Brush_2(cid, level, maglevel)
	return (1000000)*-1,(1000000)*-1 
...
setCombatArea(combat8_Brush,createCombatArea({{0, 2, 0},
{0, 1, 0},
{1, 1, 1},
{0, 1, 0}}))
function getDmg_Brush(cid, level, maglevel)
...
local dfcombat8_Brush = {CONST_ANI_POISON,0,1,0,2,-1,2,0,3,1,2}local combat8_Brush_2 = createCombatObject()
...
setCombatArea(combat8_Brush_2,createCombatArea({{0, 1, 0},
{1, 1, 1},
{0, 1, 0},
{0, 2, 0}}))
function getDmg_Brush_2(cid, level, maglevel)
...
setCombatArea(combat9_Brush,createCombatArea({{0, 0, 1, 0},
{2, 1, 1, 1},
{0, 0, 1, 0}}))
function getDmg_Brush(cid, level, maglevel)
	return (1000000)*-1,(1000000)*-1 
...
local dfcombat9_Brush = {CONST_ANI_POISON,1,0,2,0,2,1,3,0,2,-1}local combat9_Brush_2 = createCombatObject()
setCombatParam(combat9_Brush_2, COMBAT_PARAM_EFFECT, CONST_ME_HITAREA)
setCombatParam(combat9_Brush_2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatArea(combat9_Brush_2,createCombatArea({{0, 1, 0, 0},
{1, 1, 1, 2},
{0, 1, 0, 0}}))
function getDmg_Brush_2(cid, level, maglevel)
	return (1000000)*-1,(1000000)*-1 
...
local dfcombat10_Brush = {CONST_ANI_POISON,0,-1,0,-2,1,-2,-1,-2,0,-3}local combat10_Brush_2 = createCombatObject()
setCombatParam(combat10_Brush_2, COMBAT_PARAM_EFFECT, CONST_ME_HITAREA)
setCombatParam(combat10_Brush_2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatArea(combat10_Brush_2,createCombatArea({{0, 2, 0},
{0, 1, 0},
{1, 1, 1},
{0, 1, 0}}))
function getDmg_Brush_2(cid, level, maglevel)
...
setCombatArea(combat11_Brush,createCombatArea({{0, 1, 0, 0},
{1, 1, 1, 2},
{0, 1, 0, 0}}))
function getDmg_Brush(cid, level, maglevel)
	return (1000000)*-1,(1000000)*-1 
...
local dfcombat11_Brush = {CONST_ANI_POISON,-1,0,-2,0,-3,0,-2,1,-2,-1}local combat11_Brush_2 = createCombatObject()
setCombatParam(combat11_Brush_2, COMBAT_PARAM_EFFECT, CONST_ME_HITAREA)
setCombatParam(combat11_Brush_2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatArea(combat11_Brush_2,createCombatArea({{0, 0, 1, 0},
{2, 1, 1, 1},
{0, 0, 1, 0}}))
function getDmg_Brush_2(cid, level, maglevel)
	return (1000000)*-1,(1000000)*-1 
...
setCombatArea(combat12_Brush,createCombatArea({{0, 2, 0},
{0, 1, 0},
{1, 1, 1},
{0, 1, 0}}))
function getDmg_Brush(cid, level, maglevel)
...
local dfcombat12_Brush = {CONST_ANI_POISON,0,1,0,2,-1,2,0,3,1,2}local combat12_Brush_2 = createCombatObject()
setCombatParam(combat12_Brush_2, COMBAT_PARAM_EFFECT, CONST_ME_HITAREA)
setCombatParam(combat12_Brush_2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatArea(combat12_Brush_2,createCombatArea({{0, 1, 0},
{1, 1, 1},
{0, 1, 0},
{0, 2, 0}}))
function getDmg_Brush_2(cid, level, maglevel)
...
setCombatArea(combat13_Brush,createCombatArea({{0, 0, 1, 0},
{2, 1, 1, 1},
{0, 0, 1, 0}}))
function getDmg_Brush(cid, level, maglevel)
	return (1000000)*-1,(1000000)*-1 
...
local dfcombat13_Brush = {CONST_ANI_POISON,1,0,2,0,2,1,3,0,2,-1}local combat13_Brush_2 = createCombatObject()
setCombatParam(combat13_Brush_2, COMBAT_PARAM_EFFECT, CONST_ME_HITAREA)
setCombatParam(combat13_Brush_2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatArea(combat13_Brush_2,createCombatArea({{0, 1, 0, 0},
{1, 1, 1, 2},
{0, 1, 0, 0}}))
function getDmg_Brush_2(cid, level, maglevel)
	return (1000000)*-1,(1000000)*-1 
...
setCombatArea(combat14_Brush,createCombatArea({{0, 1, 0},
{1, 1, 1},
{0, 1, 0},
{0, 2, 0}}))
function getDmg_Brush(cid, level, maglevel)
...
local dfcombat14_Brush = {CONST_ANI_POISON,0,-1,0,-2,1,-2,0,-3,-1,-2}local combat14_Brush_2 = createCombatObject()
setCombatParam(combat14_Brush_2, COMBAT_PARAM_EFFECT, CONST_ME_HITAREA)
setCombatParam(combat14_Brush_2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatArea(combat14_Brush_2,createCombatArea({{0, 2, 0},
{0, 1, 0},
{1, 1, 1},
{0, 1, 0}}))
function getDmg_Brush_2(cid, level, maglevel)
...
setCombatArea(combat15_Brush,createCombatArea({{0, 1, 0, 0},
{1, 1, 1, 2},
{0, 1, 0, 0}}))
function getDmg_Brush(cid, level, maglevel)
	return (1000000)*-1,(1000000)*-1 
...
local dfcombat15_Brush = {CONST_ANI_POISON,-1,0,-2,0,-3,0,-2,-1,-2,1}local combat15_Brush_2 = createCombatObject()
setCombatParam(combat15_Brush_2, COMBAT_PARAM_EFFECT, CONST_ME_HITAREA)
setCombatParam(combat15_Brush_2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatArea(combat15_Brush_2,createCombatArea({{0, 0, 1, 0},
{2, 1, 1, 1},
{0, 0, 1, 0}}))
function getDmg_Brush_2(cid, level, maglevel)
	return (1000000)*-1,(1000000)*-1 
...
setCombatArea(combat16_Brush,createCombatArea({{0, 2, 0},
{0, 1, 0},
{1, 1, 1},
{0, 1, 0}}))
function getDmg_Brush(cid, level, maglevel)
...
local dfcombat16_Brush = {CONST_ANI_POISON,0,1,0,2,0,3,-1,2,1,2}local combat16_Brush_2 = createCombatObject()
setCombatParam(combat16_Brush_2, COMBAT_PARAM_EFFECT, CONST_ME_HITAREA)
setCombatParam(combat16_Brush_2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatArea(combat16_Brush_2,createCombatArea({{0, 1, 0},
{1, 1, 1},
{0, 1, 0},
{0, 2, 0}}))
function getDmg_Brush_2(cid, level, maglevel)
...
setCombatArea(combat17_Brush,createCombatArea({{0, 0, 1, 0},
{2, 1, 1, 1},
{0, 0, 1, 0}}))
function getDmg_Brush(cid, level, maglevel)
	return (1000000)*-1,(1000000)*-1 
...
local dfcombat17_Brush = {CONST_ANI_POISON,1,0,2,0,2,1,3,0,2,-1}local combat17_Brush_2 = createCombatObject()
setCombatParam(combat17_Brush_2, COMBAT_PARAM_EFFECT, CONST_ME_HITAREA)
setCombatParam(combat17_Brush_2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatArea(combat17_Brush_2,createCombatArea({{0, 1, 0, 0},
{1, 1, 1, 2},
{0, 1, 0, 0}}))
function getDmg_Brush_2(cid, level, maglevel)
	return (1000000)*-1,(1000000)*-1 
...
setCombatArea(combat18_Brush,createCombatArea({{0, 1, 0},
{1, 1, 1},
{0, 1, 0},
{0, 2, 0}}))
function getDmg_Brush(cid, level, maglevel)
...
local dfcombat18_Brush = {CONST_ANI_POISON,0,-1,0,-2,-1,-2,0,-3,1,-2}local combat18_Brush_2 = createCombatObject()
setCombatParam(combat18_Brush_2, COMBAT_PARAM_EFFECT, CONST_ME_HITAREA)
setCombatParam(combat18_Brush_2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatArea(combat18_Brush_2,createCombatArea({{0, 2, 0},
{0, 1, 0},
{1, 1, 1},
{0, 1, 0}}))
function getDmg_Brush_2(cid, level, maglevel)
...
local dfcombat19_Brush = {CONST_ANI_POISON}local combat19_Brush_2 = createCombatObject()
setCombatParam(combat19_Brush_2, COMBAT_PARAM_EFFECT, CONST_ME_HITAREA)
setCombatParam(combat19_Brush_2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatArea(combat19_Brush_2,createCombatArea({{0, 0, 1, 0},
{2, 1, 1, 1},
{0, 0, 1, 0}}))
function getDmg_Brush_2(cid, level, maglevel)
	return (1000000)*-1,(1000000)*-1 
