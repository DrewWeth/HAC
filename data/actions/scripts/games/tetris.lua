...
local score = 21451
local config = {
    uppos = {x = 9999, y = 10361, z = 7},
    dowpos = {x = 10005, y = 10372, z = 7},
    playerpos = {x = 10007, y = 10369, z = 7},
    block_start={x = 10002, y=10364, z=7},
    exit={x = 2000, y = 2000, z = 7},
    delay= 10,
    item= 11200,
    effects = {
        mark=3,
...
local function control_loop(startpos) -- Function by mock
    ...
    doSendAnimatedText(getCreaturePosition(config.data[2]), "point: "..poi, math.random(1,255))
    startpos.stackpos = 2
...
function onUse(cid, item, fromPosition, itemEx, toPosition)
    if not config.data[2] then
        ...
        doPlayerSendCancel(cid,'Someone is already playing Tetris, please wait till he finish')
    end
    return false
end