...
-- POSITIONS
ZE_blockEnterItemPosition = {x= 1917, y=1943, z=7}
ZE_enterPosition = {x = 1879, y = 1837, z = 7}
ZE_kickPosition = {x=2000, y=2000, z=7}
ZE_spawnFromPosition = {x = 1853, y = 1787, z = 7}
ZE_spawnToPosition = {x = 1904, y = 1823, z = 7}
-- ITEM IDS
